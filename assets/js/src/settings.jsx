    ...
    function Form(props) {
        return (
            <React.Fragment>
                ...
                <Option type="control" name="mobbex_finance_trip" value={props.configs.mobbex_finance_trip} label="Financiación en Viaje" description="Mostrar el botónde financiación con planes de pago en la página del viaje."/>
            </React.Fragment>
        );
    }
