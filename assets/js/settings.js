...
(function (window) {
    ...
    function Form(props) {
        return React.createElement(
            ...
            React.createElement(Option, { type: 'control', name: 'mobbex_finance_trip', value: props.configs.mobbex_finance_trip, label: 'Mostrar Financiacion en Viaje', description: 'Mostrar planes de pago en el viaje.' })
        );
    }
